...
namespace ScheduleRunner
{
    public class Helper
    {
        ...
        public static void PrintHelp() {
            ...
            Console.WriteLine(@"    [*] /program      - Specify the program that the task runs");
            Console.WriteLine(@"    /argument         - Specify the command line argument for the program");
            Console.WriteLine(@"    /oldaction	      - Specify the old program that will be replaced with program");
            Console.WriteLine(@"    /order	          - Specify the index in actions in which the new program will be added (1-based)");
            ...
            Console.WriteLine(@"");
            Console.WriteLine(@"Edit a scheduled task called ""Cleanup"" by changing its execution action to ""C:\Payload\backdoor.exe"" with argument ""--exec ls"":");
            Console.WriteLine(@"    ScheduleRunner.exe /method:edit /taskname:Cleanup /program:""C:\Payload\backdoor.exe"" /argument:""--exec ls""");
            Console.WriteLine(@"");
            Console.WriteLine(@"Edit a scheduled task called ""Cleanup"" with multiple execution actions by replacing the old action ""C:\Windows\notepad.exe"" to ""C:\Payload\backdoor.exe"":");
            Console.WriteLine(@"    ScheduleRunner.exe /method:edit /taskname:Cleanup /program:""C:\Payload\backdoor.exe"" /oldaction:""C:\Windows\notepad.exe""");
            Console.WriteLine(@"");
            Console.WriteLine(@"Edit a scheduled task called ""Cleanup"" with multiple execution actions by inserting the new action ""C:\Payload\agent.exe"" as the second entry:");
            Console.WriteLine(@"    ScheduleRunner.exe /method:edit /taskname:Cleanup /program:""C:\Payload\agent.exe"" /order:2");
            Console.WriteLine(@"");
